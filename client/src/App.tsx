...
function Router() {
  ...
  const [businessData, setBusinessData] =
    useState<BusinessDataWizardData | null>(() => {
  ...
  return (
    <Switch>
      ...
      <Route path="/ux-showcase">{() => <UXShowcase />}</Route>

      <Route path="/live-benchmarks">{() => <LiveBenchmarks />}</Route>

      <Route path="/our-approach">{() => <OurApproach />}</Route>

      <Route path="/who-we-serve">{() => <WhoWeServe />}</Route>

      <Route path="/industry-insights">{() => <IndustryInsights />}</Route>

      <Route path="/valuation-services">{() => <ValuationServices />}</Route>

      <Route path="/european-markets">{() => <EuropeanMarkets />}</Route>

      <Route path="/success-stories">{() => <SuccessStories />}</Route>

      <Route path="/about-us">{() => <AboutUs />}</Route>

      <Route path="/our-team">{() => <OurTeam />}</Route>

      <Route path="/ai-test">{() => <AIFeatureTest />}</Route>

      <Route path="/emilia-showcase">{() => <EmiliaShowcase />}</Route>
